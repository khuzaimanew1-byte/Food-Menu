...
- [esbuild NestJS decorator metadata fix](esbuild-nestjs-decorators.md) — NestJS DI silently injects undefined without @anatine/esbuild-decorators plugin + emitDecoratorMetadata:true in tsconfig.
