...
function MenuBorder({ pg = 1 }) {
  const uid = useId().replace(/:/g, "");
  const cornerId = `corner-tl-${uid}`;

  const formattedNumber = pg ? String(pg).padStart(2, "0") : null;
      ...
      >
        ...
        {formattedNumber !== null && (
          <g transform="translate(527, 1422)">
            <path
              className="gold-stroke thin"
              d="M 0,-40 C 25,-40 35,-20 45,0 C 35,20 25,40 0,40 C -25,40 -35,20 -45,0 C -35,-20 -25,-40 0,-40 Z"
            />
            <path
              className="gold-stroke hairline"
              d="M 0,-30 C 15,-30 25,-15 33,0 C 25,15 15,30 0,30 C -15,30 -25,15 -33,0 C -25,-15 -15,-30 0,-30 Z"
            />
...
// <MenuBorder pg={1} />     -> emblem + number visible
// <MenuBorder pg={false} /> -> emblem + number hidden
