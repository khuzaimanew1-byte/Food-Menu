...
function MenuHeading({ text = "Turkish Specialties", showCrown = true, size = "28px" }: MenuHeadingProps) {
  ...
  return (
    <div className="mh-wrap" style={{ fontSize: size }}>
      {showCrown && (
        <svg className="mh-crown" viewBox="0 0 100 40">
          ...
          <circle cx="50" cy="15" r="4" fill="var(--gold)"/>
          <path d="M43 25 Q50 15 57 25" stroke="var(--gold)" fill="none" strokeWidth="1.5"/>
          <path d="M35 15 Q25 5 15 15 T15 25" stroke="var(--gold)" fill="none" strokeWidth="1.5"/>
        ...
        <div className="mh-div">
          <svg preserveAspectRatio="none" viewBox="0 0 100 10">
            ...
            <g mask={`url(#mask-l-${uid})`}>
              <line x1="0" y1="5" x2="90" y2="5" stroke="var(--gold)" strokeWidth="1"/>
              <polygon points="90,5 95,2 100,5 95,8" fill="var(--gold)"/>
              <polygon points="10,5 15,2 20,5 15,8" fill="var(--gold)"/>
            </g>
          </svg>
        </div>
        <h2 className="mh-ttl">{text}</h2>
        <div className="mh-div">
          <svg preserveAspectRatio="none" viewBox="0 0 100 10">
            <defs>
            ...
            <g mask={`url(#mask-r-${uid})`}>
              <polygon points="0,5 5,2 10,5 5,8" fill="var(--gold)"/>
              <polygon points="80,5 85,2 90,5 85,8" fill="var(--gold)"/>
              <line x1="10" y1="5" x2="100" y2="5" stroke="var(--gold)" strokeWidth="1"/>
            </g>
          </svg>
        </div>
      </div>
