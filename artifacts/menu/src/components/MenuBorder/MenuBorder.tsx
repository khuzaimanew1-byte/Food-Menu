  ...
  return (
    <div className="mb-wrap">
      ...
      >
        ...
        <use
          href={`#${cornerId}`}
          transform="translate(1054,0) scale(-1,1)"
          x="0"
          y="0"
        />
        <use
          href={`#${cornerId}`}
          transform="translate(0,1492) scale(1,-1)"
          x="0"
          y="0"
        />
        <use
          href={`#${cornerId}`}
          transform="translate(1054,1492) scale(-1,-1)"
          x="0"
          y="0"
        />
        {formattedNumber !== null && (
          <g transform="translate(527,1422)">
            ...
            <path
              className="mb-gs mb-th"
              d="M -240,-10 L -250,0 L -240,10 L -230,0 Z"
            />
            <line className="mb-gs mb-th" x1="45" x2="230" y1="0" y2="0" />
            <circle className="mb-gf" cx="52" cy="0" r="2.5" />
            <circle className="mb-gf" cx="240" cy="0" r="3" />
